...
for company in companies:
	...
	c = csv.writer(VAcsv)
	c.writerow(['date', 'stock0', 'stock1', 'stock2', 'stock3','tweet0', 'tweet1', 'tweet2', 'tweet3'])
	for i in range(4,len(VAlist)):
	...
	model = ols("stock0 ~ stock1 + stock2 + tweet0 + tweet1 + tweet2", data).fit()
	print(company)
	output.write(company + '\r\n')
	output.write("lag n: " + str(n) + '\r\n')
